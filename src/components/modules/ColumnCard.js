...
const ColumnCard = ({priority, desc, cover, delay}) => {
    return (
        <motion.div className={columncardStyles.columnCardWrap} initial={{ y:100 }} animate={{ y:0 }} transition={{ delay: `.${delay}`, type: "spring" }}>
