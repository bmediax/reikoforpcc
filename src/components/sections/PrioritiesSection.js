        ...
        <SectionLayout topic="priorities" tag="priorities">
            ...
            <div className="three-column-option_container">
                <div className="three-column-option">
                    <div>
                        <center>
                            <StaticImage src="../../images/gfx/icons/circlePeople.png" alt="This is an imgae" width={120} />
                        </center>
                    ...
                    <div>
                        <center>
                            <StaticImage src="../../images/gfx/icons/heartHand.png" alt="This is an image" width={120} />
                        </center>
                    ...
                    <div>
                        <center>
                            <StaticImage src="../../images/gfx/icons/eye.png" alt="This is an imgae" width={120} />
                        </center>
